  ...
  return (
    <div className={`${styles.app}`}>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="StormShop: Subscription and Script Store, as well as a project for creating personal scripts!"
        />
      ...
      <div
        className={`${styles.purple_light} ${resStyles(
          "purple_light",
          resolutions
        )}`}
      ></div>{" "}
      {/* Purple glow */}
      <div
        className={`${styles.blue_light} ${resStyles(
          "blue_light",
          resolutions
        )}`}
      ></div>{" "}
      {/* Blue glow */}
      <div
        className={`${styles.yellow_light} ${resStyles(
          "yellow_light",
          resolutions
        )}`}
      ></div>{" "}
